...
import 'package:money_manager/Screens/screenanalyticscategory.dart';
import 'package:money_manager/db/Report_data_.dart';

import '../model/transaction.dart/transaction.dart';

class AdvancedDataIncome extends StatelessWidget {
  final value_notifer_index;
  const AdvancedDataIncome({super.key, required this.value_notifer_index});

  @override
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        valueListenable: advanced_data_notifier_income,
        builder:
...
List<List> List_giver() {
  final lst = advanced_data_notifier_income.value;
  final List _lst2 = [];
  final List _lst3 = [];
